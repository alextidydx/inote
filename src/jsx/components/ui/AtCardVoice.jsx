...
import '../../../styles/ui/at-card-voice.scss'
...
import VoiceIcon from '../../../images/note-voice.svg?react'
...
export default class AtCardVoice extends React.Component {
	timer = null
			...
			<div className={classnames} ref={this.container} onClick={this.props.data.click}>
				<div className="at__card__content-container" >
					<div className="at__card__label">
						<div className="at__card__ico"><VoiceIcon /></div>
					...
					<div className="at__card__content">
						<div className="at__card__content-wrapper">
							<div className="at__card-voice__img" style={{ backgroundImage: "url('./assets/images/sound.png')" }}></div>
