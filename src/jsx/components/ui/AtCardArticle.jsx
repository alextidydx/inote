...
import '../../../styles/ui/at-card-article.scss'
...
import ArticleIcon from '../../../images/note-article.svg?react'
...
export default class AtCardArticle extends React.Component {
	timer = null
			...
			<div className={classnames} ref={this.container} onClick={this.props.data.click}>
				<div className="at__card__content-container" >
					<div className="at__card__label">
						<div className="at__card__ico"><ArticleIcon /></div>
						<div className="at__card__title">{ this.props.data.title }</div>
						<Link to={ this.props.data.link }>Learn more<ForwardIco /></Link>
					</div>
					<div className="at__card__content">
						<div className="at__card__content-wrapper">
							<div className="at__card-article__img" style={{ backgroundImage: "url(" + this.props.data.imgSrc + ")" }}></div>
